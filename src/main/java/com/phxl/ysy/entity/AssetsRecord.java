...
public class AssetsRecord {
    ...
    public void setSourceFunds(String sourceFunds) {
        this.sourceFunds = sourceFunds == null ? null : sourceFunds.trim();
    }
    ...
    public void setbDeptCode(String bDeptCode) {
        this.bDeptCode = bDeptCode == null ? null : bDeptCode.trim();
    }
    ...
    public void setaDeptCode(String aDeptCode) {
        this.aDeptCode = aDeptCode == null ? null : aDeptCode.trim();
    }
    ...
    public void setMaintainDay(String maintainDay) {
        this.maintainDay = maintainDay == null ? null : maintainDay.trim();
    }

    public String getAssetsUseOrg() {
        return assetsUseOrg;
    }

    public void setAssetsUseOrg(String assetsUseOrg) {
        this.assetsUseOrg = assetsUseOrg == null ? null : assetsUseOrg.trim();
    }
    ...
    public void setUseFstate(String useFstate) {
        this.useFstate = useFstate == null ? null : useFstate.trim();
    }

    public Date getRecodrDate() {
        return recodrDate;
    }

    public void setRecodrDate(Date recodrDate) {
        this.recodrDate = recodrDate;
    }
