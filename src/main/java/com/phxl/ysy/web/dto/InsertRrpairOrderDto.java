...
public class InsertRrpairOrderDto {
	...
	private List<String> faultDescribe;
	...
	public Boolean getIsRepairs() {
		return isRepairs;
	}
	public void setIsRepairs(Boolean isRepairs) {
	...
	public void setRrpairPhone(String rrpairPhone) {
		this.rrpairPhone = rrpairPhone;
	}
	public String getUseFstate() {
		return useFstate;
	}
	public List<String> getFaultDescribe() {
		return faultDescribe;
	}
	public void setFaultDescribe(List<String> faultDescribe) {
		this.faultDescribe = faultDescribe;
	}
	public void setUseFstate(String useFstate) {
		this.useFstate = useFstate;
	}
	...
	public void setFaultWords(String faultWords) {
		this.faultWords = faultWords;
	}
	public List<String> getTfAccessory() {
		return tfAccessory;
	}
	public void setTfAccessory(List<String> tfAccessory) {
	...
	public void setRepairContentTyp(String repairContentTyp) {
		this.repairContentTyp = repairContentTyp;
	}
	...
	public void setOutRrpairPhone(String outRrpairPhone) {
		this.outRrpairPhone = outRrpairPhone;
	}
	...
	public List<Map<String, Object>> getAssetsExtendGuids() {
		return assetsExtendGuids;
	}
